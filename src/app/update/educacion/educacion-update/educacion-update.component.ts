...
export class EducacionUpdateComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.eduservice.getOneEducation(id).subscribe((data)=>this.educacion=data)
  }

  update(){
    this.eduservice.updateEducacion(this.educacion).subscribe(()=>alert('Se ha actualizado la educacion de forma correcta!'))
